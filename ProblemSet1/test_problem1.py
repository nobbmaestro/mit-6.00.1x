...
class TestProblem1(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_data = {
            ...
            1: {
                'input': 'yljhetearelonjugthfmxm',
                'output': 6
            },
            2: {
                'input': 'ypyegaugpiulfxilvso',
                'output': 7
            },
            3: {
                'input': 'tiaaltmazuadiaxij',
                'output': 9
            },
            4: {
                'input': 'hocovearla',
            ...
            10: {
                'input': 'hkuwqkzhcpsairiiasaooeuo',
                'output': 12
            },
            11: {
                'input': 'vtugaadyseoohceuatleospx',
                'output': 11
            },
            12: {
                'input': 'gduierevenxhsatevwyvtnl',
                'output': 7
            },
            13: {
                'input': 'viuwogidukkqaulkeui',
                'output': 10
            },
            14: {
                'input': 'zppihlhmyiesaitrehdu',
                'output': 7
            },
            15: {
                'input': 'eittloo',
            ...
            18: {
                'input': 'gwfcwestuayoakee',
                'output': 7
            },
            19: {
                'input': 'aaigtqbbqakitijrei',
                'output': 8
            },
        }
