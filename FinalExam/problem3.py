...
# no non- negative integer combination of 6's, 9's and 20's add up to 16. To determine if it is possible to buy exactly n 
# McNuggets, one has to find non-negative integer (can be 0) values of a, b, and c such that
#
#                                           6a + 9b + 20c = n
#
