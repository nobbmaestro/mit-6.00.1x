...
def minMonthlyPayment(balance, annualInterestRate):
    ...
    while getBalance(balance, annualInterestRate, minimumFixedMonthlyPayment) >= epsilon:
...
def main():
    ...
    msg = 'Lower Payment: {payment}'
    print(msg.format(payment=minMonthlyPayment(balance, annualInterestRate)))
