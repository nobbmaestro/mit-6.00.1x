...
class TestProblem1(unittest.TestCase):
    ...
    def test_output(self):
        ...
        for i in self.test_data.keys():
            balance = self.test_data[i]['input'][0]
            annualInterestRate = self.test_data[i]['input'][1]
            monthlyPaymentRate = self.test_data[i]['input'][2]

            result = func(balance, annualInterestRate, monthlyPaymentRate)
