...
# into the problem of slow code? We can make this program run faster using a technique introduced in lecture - bisection search!
#
...
def main():
    ...
    msg = 'Lowest Payment: {minMonthlyPayment}'
    print("Lowest Payment: " + str(minMonthlyPaymentBisect(balance, annualInterestRate)))
