...
- **test_getWordScore()**, tests the getWordScore() implementation.

- **test_updateHand()**, tests the updateHand() implementation.

- **test_isValidWord()**, tests the isValidWord() implementation.
