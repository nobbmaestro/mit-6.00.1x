...
class TestProblem1(unittest.TestCase):
    def setUp(self):
        self.test_data = {
            0:  {'input': ['', 10],             'output': 0},
            1:  {'input': ['qi', 7],            'output': 22},
            2:  {'input': ['was', 7],           'output': 18},
            3:  {'input': ['outgnaw', 7],       'output': 127},
            4:  {'input': ['triplet', 7],       'output': 113},
            5:  {'input': ['triplet', 8],       'output': 63},
            6:  {'input': ['dogs', 4],          'output': 74},
            7:  {'input': ['cats', 7],          'output': 24},
            8:  {'input': ['kids', 5],          'output': 36},
            9:  {'input': ['onomatopoeia', 12], 'output': 242},
        }
