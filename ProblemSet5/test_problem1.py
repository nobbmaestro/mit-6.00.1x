...
class TestProblem1(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_data_text = {
            ...
            1: {
                'input': ['we are taking 6.00.1x', 6],
                'output': 'ck gxk zgqotm 6.00.1d'
            },
            2: {
                'input': ['th!s is Problem Set 6?', 18],
                'output': 'lz!k ak Hjgtdwe Kwl 6?'
            },
            3: {
                'input': ['TESTING.... so many words we are testing out your code: last one', 16],
